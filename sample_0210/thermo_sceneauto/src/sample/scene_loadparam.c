...
static hi_s32 scene_load_static_thermo(const hi_char *module, ot_scene_static_thermo *curve_attr)
{
    ot_scenecomm_check_pointer_return(curve_attr, HI_FAILURE);
    hi_s32 ret;
    hi_s32 get_value;

    scene_load_int(module, "static_thermo:clip", curve_attr->clip, hi_u16);
    scene_load_int(module, "static_thermo:fusion_ratio", curve_attr->fusion_ratio, hi_u8);
    scene_load_array(module, "static_thermo:fusion_curve", curve_attr->fusion_curve_value,
        HI_ISP_GAMMA_NODE_NUM, hi_u16);
    return HI_SUCCESS;
}
...
static hi_s32 scene_load_dynamic_aidrc(const hi_char *module, ot_scene_module_state *module_state,
