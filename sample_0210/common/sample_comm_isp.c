...
static hi_isp_pub_attr g_isp_pub_attr_hw_dc_8m_30fps = {
	{0,0,HW_WIDTH_1024,HW_HEIGHT_768},
	{HW_WIDTH_1024,HW_HEIGHT_768},
	25,
	HI_ISP_BAYER_BGGR,
	HI_WDR_MODE_NONE,
	0,
...
static hi_void sample_comm_isp_get_pub_attr_by_sns_part1(sample_sns_type sns_type, hi_isp_pub_attr *pub_attr)
{
	...
	case HW_DC:
	    (hi_void)memcpy_s(pub_attr,sizeof(hi_isp_pub_attr),
		&g_isp_pub_attr_hw_dc_8m_30fps,sizeof(hi_isp_pub_attr));
	    break;
