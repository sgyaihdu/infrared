...
#define HW_WIDTH_1024 512
#define HW_HEIGHT_768 768
...
typedef struct {
    ...
    hi_u8  reg_value;
    hi_u8  reg_width;
    hi_u8  reg_value_width;

}mipi_tx_i2c_cmd_info_LT;
...
typedef struct {
    ...
    hi_u32 i2c_cmd_count;//i2c 命令个数
    hi_u8 i2c_bus;//i2c 总线地址
    hi_u8 i2c_addr;//i2c 设备地址 不含读写位
    //hi_s32 i2c_fd;//打开的i2c设备的文件描述符
    mipi_tx_i2c_cmd_info* i2c_cmd_info;//i2c 命令

    hi_bool lt9211_i2c_cmd_en1; 
    hi_u32  lt9211_i2c_bus1;
    unsigned int   lt9211_i2c_addr1;
    hi_u32  lt9211i2c_cmd_count1;//i2c 命令个数
    mipi_tx_i2c_cmd_info* lt9211_i2c_cmd_info1 ;
    /* for user sync */
...
typedef struct {
    ...
    hi_u32 i2c_cmd_count;//i2c 命令个数
    hi_u8 i2c_bus;//i2c 总线地址
    unsigned int i2c_addr;//i2c 设备地址 不含读写位
    //hi_s32 i2c_fd;//打开的i2c设备的文件描述符
    mipi_tx_i2c_cmd_info* i2c_cmd_info;//i2c 命令
}sample_mipi_LT_config;
...
#define VI_CROP_IS_ENANLE 0

#if VI_CROP_IS_ENANLE

    // #define ISR2006_CROP_X 760
    // #define ISR2006_CROP_Y 460
    // #define ISR2006_CROP_WIDTH 400
    // #define ISR2006_CROP_HEIGHT 400

    #define ISR2006_CROP_X 0
    #define ISR2006_CROP_Y 0
    #define ISR2006_CROP_WIDTH 968
    #define ISR2006_CROP_HEIGHT 640
...
#define SAVE_STREAM_TO_FILE_H265 0

#define FPN_ENABLE 0

#define RTSP_OWN_ENABLE 1

#define SENSOR_TYPE SENSOR1_TYPE

#define ISR2006_IS_MONO 0
