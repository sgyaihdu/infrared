...
static hi_char *g_model_file = "./ai3dnr/model/ai3dnr_model.bin";
...
static hi_s32 sample_ai3dnr_start(hi_vi_pipe vi_pipe, hi_size in_size, hi_ai3dnr_model *model_info, hi_s32 *model_id,
...
static hi_s32 sample_ai3dnr_stop(hi_vi_pipe vi_pipe, hi_ai3dnr_model *model, hi_s32 model_id)
{
...
static hi_void sample_ai3dnr_stop_vi(hi_vi_pipe vi_pipe, const sample_vi_cfg *vi_cfg)
{
    sample_ai3dnr_detach_vb(vi_pipe);
    sample_comm_vi_stop_vi(vi_cfg);
}

static hi_s32 sample_ai3dnr_start_vi(hi_vi_pipe vi_pipe, const sample_vi_cfg *vi_cfg, hi_size *in_size,
