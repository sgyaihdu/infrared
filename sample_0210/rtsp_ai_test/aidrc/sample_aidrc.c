...
static hi_char *g_model_file = "./aidrc/model/aidrc_model.bin";
...
static hi_s32 sample_aidrc_start(hi_vi_pipe vi_pipe, hi_size in_size, hi_aidrc_model *model_info,
...
static hi_s32 sample_aidrc_stop(hi_vi_pipe vi_pipe, hi_aidrc_model *model, hi_s32 *model_id, hi_s32 model_size)
{
...
static hi_s32 sample_aidrc_start_vi(hi_vi_pipe vi_pipe, const sample_vi_cfg *vi_cfg, hi_size *in_size,
...
static hi_void sample_adrc_stop_vi(hi_vi_pipe vi_pipe, const sample_vi_cfg *vi_cfg)
{
