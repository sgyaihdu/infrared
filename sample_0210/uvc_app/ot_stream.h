...
typedef struct ot_stream {
    ...
    int streaming;
    hi_bool exposure_auto_stall;
    hi_bool brightness_stall;
} ot_stream;
...
extern void ot_stream_event_pu_control(struct hi_uvc_dev *dev, uint8_t req, uint8_t unit_id, uint8_t cs,
    struct uvc_request_data *resp);

extern void ot_stream_event_it_control(struct hi_uvc_dev *dev, uint8_t req, uint8_t unit_id, uint8_t cs,
    struct uvc_request_data *resp);

extern void ot_stream_event_eu_h264_control(struct hi_uvc_dev *dev, uint8_t req, uint8_t unit_id, uint8_t cs,
    struct uvc_request_data *resp);

extern void ot_stream_event_eu_camera_control(struct hi_uvc_dev *dev, uint8_t req, uint8_t unit_id, uint8_t cs,
    struct uvc_request_data *resp);
...
extern void ot_stream_event_eu_h264_data(struct hi_uvc_dev *dev, int unit_id, int control,
    struct uvc_request_data *data);

extern void ot_stream_event_pu_data(struct hi_uvc_dev *dev, int unit_id, int control, struct uvc_request_data *data);

extern void ot_stream_event_it_data(struct hi_uvc_dev *dev, int unit_id, int control, struct uvc_request_data *data);

extern void ot_stream_event_eu_camera_data(struct hi_uvc_dev *dev, int unit_id, int control,
    struct uvc_request_data *data);
