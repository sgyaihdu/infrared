    ...
    hi_compress_mode compress_mode, td_u32 blk_cnt)
{
    ...
    pic_buf_attr.bit_width = HI_DATA_BIT_WIDTH_16;
    ...
    sample_venc_vpss_chn_attr *vpss_chan_attr)
{
    ...
    if(SENSOR_TYPE == SAMPLE_VI_MODE_BT1120_1080P_16BIT)
    {
        vpss_chan_attr->pixel_format = HI_PIXEL_FORMAT_YVU_SEMIPLANAR_422;
    }
    ...
    sample_venc_vpss_chn_attr *vpss_param)
{
    hi_s32 i;
    hi_s32 ret;
    hi_pic_size pic_size[CHN_NUM_MAX] = {SMALL_STREAM_SIZE, SMALL_STREAM_SIZE};
    ...
    hi_vpss_grp vpss_grp, sample_venc_vpss_chn *venc_vpss_chn)
{
    ...
    /* *****************************************
     stream save process
    ***************************************** */
    if ((ret = sample_comm_venc_start_get_stream(venc_vpss_chn->venc_chn, CHN_NUM_MAX-1)) != HI_SUCCESS) {
