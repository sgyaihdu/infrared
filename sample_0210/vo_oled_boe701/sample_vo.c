...
#define  PRINTF_DEBUG {printf("file:%s func:%s line:%d\n",__FILE__,__func__,__LINE__);}
...
#define I2C_CMD_COUNT_1080P_LT 1
#else
#define I2C_CMD_COUNT_1080P 40
#endif

#define I2C_BUS_NUM 5
#define I2C_DEV_ADDR ((0x98)>>1)

#define I2C_BUS_NUM_9211 7

#define I2C_9211 0x5a
#if 0
...
static mipi_tx_i2c_cmd_info_LT g_i2c_cmd_info_LT9211_1080p60[I2C_CMD_COUNT_1080P_LT] = {
    {0x8100,0x95,2,1},
    //{0x8101,2,1,0},
...
/* for device */
        ...
        .pic_size = PIC_1080P,
        .bg_color = COLOR_RGB_YELLOW,//背景颜色
/* for layer */
        .pix_format = HI_PIXEL_FORMAT_YVU_SEMIPLANAR_420,
...
/* for user sync */
    ...
    .tx_config = {
        ...
        .lt9211_i2c_cmd_en1 = HI_TRUE,
        .lt9211_i2c_bus1 = I2C_BUS_NUM_9211,
        .lt9211_i2c_addr1 = I2C_9211,//不含读写位
        .lt9211i2c_cmd_count1 = I2C_CMD_COUNT_1080P_LT,
        .lt9211_i2c_cmd_info1 = g_i2c_cmd_info_LT9211_1080p60,
