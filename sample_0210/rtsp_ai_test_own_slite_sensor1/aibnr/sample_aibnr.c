...
hi_s32 sample_aibnr_line_switch_to_wdr(hi_void)
{
    ...
    sample_sns_type wdr_sns_type = sample_aiisp_get_wdr_sns_type(SENSOR_TYPE);
...
hi_s32 sample_aibnr(sample_aibnr_param *aibnr_param)
{
    ...
    sample_sns_type sns_type = aibnr_param->is_wdr_mode ? sample_aiisp_get_wdr_sns_type(SENSOR_TYPE) : SENSOR_TYPE;
